...
import bos.tis.biztrace.parser.BSResolver;
import bos.tis.biztrace.parser.BizTraceResolver;
import bos.tis.biztrace.parser.DefaultResolver;
...
public class TISLogFile {
	...
	private void setDateFromPath(String absolutePath) {
		...
		// 确定日志发生日期 
		this.dateStr = Helper.getDatePatternFromStr(absolutePath) ; 
	}
