 ...
 */
MetronicApp.controller('workgroup_controller', function ($filter,$rootScope, $scope, $state, $stateParams, filterFilter,workgroup_service, $modal, $http, $timeout,$interval) {
