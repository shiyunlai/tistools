/**
 * Created by gaojie on 2017/5/16.
 */
/*!
...
!function () {
            ...
            link: function (d, h, i, j) {
                if (d.dynamicStyles = "", j && j.grid && j.grid.options && j.grid.options.gridMenuTemplate) {
                    ...
                    e.getTemplate(k).then(function (b) {
                        var c = angular.element(b), e = a(c)(d);
                        h.replaceWith(e)
                    })["catch"](angular.noop)
                }
                var l = function (a) {
                ...
                j && (l(j.grid.gridHeight), j.grid.api.core.on.gridDimensionChanged(d, function (a, b, c, d) {
                    l(c)
                })), d.i18n = {close: g.getSafeText("columnMenu.close")}, d.showMenu = function (a, c) {
            ...
            compile: function () {
                return {
                    post: function (d, e, f, g) {
                        ...
                        function k() {
                            var a = m.options.minRowsToShow * m.options.rowHeight, f = m.options.showHeader ? m.options.headerRowHeight : 0, g = m.calcFooterHeight(), h = 0;
    ...
    angular.module("ui.grid").factory("Grid", ["$q", "$compile", "$parse", "gridUtil", "uiGridConstants", "GridOptions", "GridColumn", "GridRow", "GridApi", "rowSorter", "rowSearcher", "GridRenderContainer", "$timeout", "ScrollEvent", function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
        ...
        p.prototype.calcFooterHeight = function () {
            ...
            })["catch"](angular.noop), g = a.when(c.processColumnsProcessors(c.columns)).then(function (a) {
        ...
        return p.prototype.renderingComplete = function () {
            ...
            var c = this, d = c.processRowsProcessors(c.rows).then(function (a) {
                c.setVisibleRows(a)
            })["catch"](angular.noop), e = c.processColumnsProcessors(c.columns).then(function (a) {
        ...
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("bg", {
                headerCell: {
                    ...
                    }, priority: "Приоритет:", filterLabel: "Филтър за колоната: "
                },
                aggregate: {label: "обекти"},
                search: {
                    placeholder: "Търсене...",
                ...
                pinning: {pinLeft: "Прикрепи вляво", pinRight: "Прикрепи вдясно", unpin: "Премахване"},
                columnMenu: {close: "Затвори"},
                gridMenu: {
                    aria: {buttonLabel: "Меню на таблицата"},
                    columns: "Колони:",
                ...
                pagination: {
                    ...
                    }, sizes: "обекта на страница", totalItems: "обекта", through: "до", of: "от"
                },
                grouping: {
                    group: "Групиране",
        ...
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("is", {
                headerCell: {
                    ...
                    }, priority: "Forgangsröðun:", filterLabel: "Sía fyrir dálka: "
                },
                aggregate: {label: "hlutir"},
                groupPanel: {description: "Dragðu dálkhaus hingað til að flokka saman eftir þeim dálki."},
                search: {
                    placeholder: "Leita...",
                ...
                pinning: {pinLeft: "Festa til vinstri", pinRight: "Festa til hægri", unpin: "Losa"},
                columnMenu: {close: "Loka"},
                gridMenu: {
                    aria: {buttonLabel: "Töflu valmynd"},
                    columns: "Dálkar:",
                ...
                pagination: {
                    ...
                    }, sizes: "hlutir á síðu", totalItems: "hlutir", through: "gegnum", of: "af"
                },
                grouping: {
                    group: "Flokka",
                    ungroup: "Sundurliða",
        ...
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("ja", {
                headerCell: {
                    ...
                    }, priority: "優先度:", filterLabel: "列フィルター: "
                },
                aggregate: {label: "項目"},
                ...
                menu: {text: "列の選択:"},
                sort: {ascending: "昇順に並べ替え", descending: "降順に並べ替え", none: "並べ替え無し", remove: "並べ替えの解除"},
                column: {hide: "列の非表示"},
                aggregation: {count: "行数: ", sum: "合計: ", avg: "平均: ", min: "最小: ", max: "最大: "},
                pinning: {pinLeft: "左に固定", pinRight: "右に固定", unpin: "固定解除"},
                columnMenu: {close: "閉じる"},
                gridMenu: {
                    aria: {buttonLabel: "グリッドメニュー"},
                    columns: "列の表示/非表示:",
        ...
        a.decorator("i18nService", ["$delegate", function (a) {
            return a.add("no", {
                headerCell: {
                    ...
                    }, priority: "Prioritet:", filterLabel: "Filter for kolonne: "
                },
                aggregate: {label: "elementer"},
                groupPanel: {description: "Trekk en kolonneoverskrift hit og slipp den for å gruppere etter den kolonnen."},
                search: {
                    placeholder: "Søk...",
                ...
                pinning: {pinLeft: "Fest til venstre", pinRight: "Fest til høyre", unpin: "Løsne"},
                columnMenu: {close: "Lukk"},
                gridMenu: {
                    aria: {buttonLabel: "Grid Menu"},
                    columns: "Kolonner:",
                    importerTitle: "Importer fil",
                ...
                pagination: {
                    ...
                    }, sizes: "elementer per side", totalItems: "elementer", through: "til", of: "av"
                },
                grouping: {
                    group: "Gruppere",
            ...
            return a.add("pt", {
                ...
                pagination: {
                    aria: {
                        ...
                        pageForward: "Próxima",
                        pageToLast: "Anterior"
                    }, sizes: "itens por página", totalItems: "itens", through: "a", of: "de"
                },
                grouping: {
                    group: "Agrupar",
                    ungroup: "Desagrupar",
                        ...
                        if (j.grid.api.cellNav) {
                            ...
                            if (e.decorateRenderContainers(n), "body" === m) {
                                ...
                                o.on("keydown", function (a) {
                                    a.uiGridTargetRenderContainerId = m;
                                    var b = j.grid.api.cellNav.getFocusedCell(), c = j.grid.options.keyDownOverrides.some(function (b) {
        ...
        var g = {
            delay: 100, initializeGrid: function (a) {
                ...
                a.api.core.addToGridMenu(a, [{
                    title: f.getSafeText("gridMenu.exporterAllAsCsv"), action: function (c) {
                    ...
                    title: f.getSafeText("gridMenu.exporterVisibleAsCsv"), action: function (c) {
                    ...
                    title: f.getSafeText("gridMenu.exporterSelectedAsCsv"), action: function (c) {
                    ...
                    title: f.getSafeText("gridMenu.exporterAllAsPdf"), action: function (c) {
                    ...
                    title: f.getSafeText("gridMenu.exporterVisibleAsPdf"), action: function (c) {
                    ...
                    title: f.getSafeText("gridMenu.exporterSelectedAsPdf"), action: function (c) {
    ...
    a.constant("uiGridGroupingConstants", {
        ...
        var j = {
            initializeGrid: function (a, b) {
                ...
                var o;
                for (m && m[l(i)] ? (o = m[l(i)].row, o.entity = {}) : (o = new e({}, null, a), f.rowTemplateAssigner.call(a, o)), o.entity["$$" + d[g].col.uid] = {groupVal: k}, o.treeLevel = g, o.groupHeader = !0, o.internalRow = !0,
        ...
        var b = {
            initializeGrid: function (a) {
                ...
                var d = function (b) {
                    ...
                    var d = parseInt(a.options.paginationPageSize, 10), e = parseInt(a.options.paginationCurrentPage, 10), f = b.filter(function (a) {
                        return a.visible
                    });
