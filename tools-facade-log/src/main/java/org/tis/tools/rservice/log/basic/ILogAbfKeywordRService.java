...
/**
 * <pre>
 * 记录关键值(LOG_ABF_KEYWORD)的基础远程服务接口定义
 * </pre>
 *
 * @autor generated by tools:gen-dao
 *
 */
public interface ILogAbfKeywordRService {
	
	/**
	 * 新增记录关键值(LOG_ABF_KEYWORD)
	 * @param t 新记录
	 */
	public void insert(LogAbfKeyword t);

	/**
	 * 更新记录关键值(LOG_ABF_KEYWORD),只修改t对象有值的字段
	 * @param t 新值
	 */
	public void update(LogAbfKeyword t);

	/**
	 * 强制更新记录关键值(LOG_ABF_KEYWORD)
	 * @param t 新值
	 */
	public void updateForce(LogAbfKeyword t);

	/**
	 * 删除记录关键值(LOG_ABF_KEYWORD)
	 * @param guid 记录guid
	 */
	public void delete(String guid);

	/**
	 * 根据条件删除记录关键值(LOG_ABF_KEYWORD)
	 * @param wc 条件
	 */
	public void deleteByCondition(WhereCondition wc);

	/**
	 * 根据条件更新记录关键值(LOG_ABF_KEYWORD)
	 * @param wc 条件
	 * @param t 新值
	 */
	...
	/**
	 * 根据条件统计记录关键值(LOG_ABF_KEYWORD)记录数
	 * @param wc 条件
	 * @return 记录数
	 */
	...
	/**
	 * 根据id查询记录关键值(LOG_ABF_KEYWORD)记录
	 * @param guid 记录guid
	 * @return 匹配的记录
	 */
