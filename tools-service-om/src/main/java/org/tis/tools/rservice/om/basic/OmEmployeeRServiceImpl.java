...
import org.tis.tools.rservice.om.basic.IOmEmployeeRService;
import org.tis.tools.service.om.OmEmployeeService;

import com.alibaba.dubbo.config.annotation.Service;

/**
 * 员工(OM_EMPLOYEE) 基本远程服务实现(服务提供者)
 * 
 * @author by generated by tools:gen-dao
 *
 */
//TEMPLATES
@Service(group = "om", version = "1.0", interfaceClass = IOmEmployeeRService.class, timeout = 2000, document = "员工的基础远程服务")
