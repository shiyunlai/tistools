...
s 系统级（平台自己的业务字典）',
	...
	-- 全局唯一标识符（GUID，Globally Unique Identifier），系统自动生成；
	GUID_PARENTS VARCHAR(128) NOT NULL COMMENT '父字典GUID : 全局唯一标识符（GUID，Globally Unique Identifier），系统自动生成；',
...
其他情况默认为空；',
	...
	-- 其他情况默认为空；
	USE_COLUMN VARCHAR(512) COMMENT '使用列作为字典项 : 如果业务字典用来描述某个表中的字段选项，则本字段保存字段名；
其他情况默认为空；',
	-- 顺序号，从0开始排，按小到大排序
