...
public class AcMenu implements Serializable {
	...
	/** The set of 菜单. */
	private Set<AcMenu> acMenuSet;

	/**
	 * Constructor.
	 */
	public AcMenu() {
		this.acMenuSet = new HashSet<AcMenu>();
	}
	 ...
	 *            菜单
	 */
	public void setparentsacMenu(AcMenu parentsacMenu) {
		this.parentsacMenu = parentsacMenu;
	}
	 ...
	 * @return 菜单
	 */
	public AcMenu getparentsacMenu() {
		return this.parentsacMenu;
	}
	...
	/**
	 * Set the set of the 菜单.
	 * 
	 * @param acMenuSet
	 *            The set of 菜单
	 */
	public void setAcMenuSet(Set<AcMenu> acMenuSet) {
		this.acMenuSet = acMenuSet;
	}
	 ...
	 *            菜单
	 */
	public void addAcMenu(AcMenu acMenu) {
		this.acMenuSet.add(acMenu);
	}

	/**
	 * Get the set of the 菜单.
	 * 
	 * @return The set of 菜单
	 */
	public Set<AcMenu> getAcMenuSet() {
		return this.acMenuSet;
	}
