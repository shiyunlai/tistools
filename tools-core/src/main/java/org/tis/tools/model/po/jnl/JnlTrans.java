...
public class JnlTrans implements Serializable {
	...
	public static final String TRANS_ERR_CODE = "trans_err_code" ; 
	/** TRANS_ERR_MSG ：交易错误信息<br/><br/>交易的错误信息，另见错误代码表 SYS_ERR_CODE */
	public static final String TRANS_ERR_MSG = "trans_err_msg" ; 
